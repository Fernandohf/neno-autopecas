...
# ícone da marca (o mesmo da placa da fachada: carro, motor e raio, disco de
# freio e porca laranja). Vai inline no HTML — nenhuma requisição extra.
def marca_svg(escuro=False):
    traco = "#ffffff" if escuro else "#2c3448"
    laranja = "#ff9538" if escuro else "#ed7a16"
    return (
        '<svg viewBox="0 0 156 100" aria-hidden="true">'
        '<g fill="none" stroke="%s" stroke-width="8.5" stroke-linecap="round" stroke-linejoin="round">'
        '<path d="M12 73C6.5 73 3.5 67 6 61.5L16 45c4-7 10.5-11 18.5-12L64 29c10.5-11 24.5-18 40-19'
        'l15-1c15-1 26 8 26 23v31c0 5.5-4 10-9.5 10"/>'
        '<path d="M58 73h34"/></g>'
        '<circle cx="38" cy="73" r="15.5" fill="none" stroke="%s" stroke-width="8.5"/>'
        '<circle cx="112" cy="73" r="16.5" fill="none" stroke="%s" stroke-width="8.5"/>'
        '<circle cx="38" cy="73" r="6" fill="%s"/>'
        '<path d="M112 64l8 4.6v9.2l-8 4.6-8-4.6v-9.2z" fill="%s"/>'
        '<path fill="%s" fill-rule="evenodd" d="M78 30h10v-5h11v5h6a6.5 6.5 0 0 1 6.5 6.5v3.5h4.5'
        'v-3.5h6.5v12h-6.5v-3.5h-4.5v3.5a6.5 6.5 0 0 1-6.5 6.5H78a6.5 6.5 0 0 1-6.5-6.5v-3h-5.5'
        'v-10h5.5v-1a6.5 6.5 0 0 1 6.5-6.5zM92.5 31.5l-10.5 12h5.8l-2.4 7.2 10.4-12.4h-5.8z"/>'
        '</svg>'
    ) % (traco, traco, traco, laranja, laranja, traco)
...
# favicon SVG embutido como data URI — zero requisição de rede
FAVICON = "data:image/svg+xml," + quote(
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">'
    '<rect width="64" height="64" rx="14" fill="#2c3448"/>'
    '<g transform="translate(3.5,14) scale(0.365)">'
    '<g fill="none" stroke="#fff" stroke-width="9" stroke-linecap="round" stroke-linejoin="round">'
    '<path d="M12 73C6.5 73 3.5 67 6 61.5L16 45c4-7 10.5-11 18.5-12L64 29c10.5-11 24.5-18 40-19'
    'l15-1c15-1 26 8 26 23v31c0 5.5-4 10-9.5 10"/><path d="M58 73h34"/></g>'
    '<circle cx="38" cy="73" r="15.5" fill="none" stroke="#fff" stroke-width="9"/>'
    '<circle cx="112" cy="73" r="16.5" fill="none" stroke="#fff" stroke-width="9"/>'
    '<circle cx="38" cy="73" r="6.5" fill="#ff9538"/>'
    '<path d="M112 64l8 4.6v9.2l-8 4.6-8-4.6v-9.2z" fill="#ff9538"/></g></svg>')
